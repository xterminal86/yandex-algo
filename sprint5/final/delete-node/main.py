...
# Если учитывать рекурсию, то в худшем случае O(2*h), где h - высота дерева,
# т.к. нам сначала нужно рекурсивно найти ноду для замены,
# а потом рекурсивно удалить её.
# Аллоцированием временной переменной можно пренебречь.
#
# Временная - O(2*h), где h - высота дерева. Двойка на поиск ноды на замену.
#
